classdef MiniCheetah < RobotLinks
    ...
    methods
        ...
        function obj = MiniCheetah(urdf)
            ...
            [config.name, config.links, config.joints, ~] = ros_load_urdf(config_file);
...
%             end
        ...
        function ExportKinematics(obj, export_function, export_path)
            ...
            for i = 1:length(obj.Joints)
                ...
                export_function(dJ, ['dJp_', obj.Joints(i).Name], export_path, {obj.States.x,obj.States.dx});%%%
            end
        ...
        function ExportCoM(obj, export_function, export_path)
            ...
            dJ_com = jacobian(v_com, obj.States.x);
            ...
            export_function(J_com, ['Jcom_', obj.Name], export_path,obj.States.x);
            export_function(dJ_com, ['dJcom_', obj.Name], export_path, {obj.States.x, obj.States.dx});
        ...
        function ExportDynamics(obj, export_function, export_path)
            ...
            disp(["num of state ",obj.numState]);
            disp(["num of joint ",length(obj.Joints)]);
